...
--비밀번호 초기화 시 해당 기존 비밀번호와 같은지 확인하는 쿼리
	SELECT COUNT(*)
		FROM USER_PROFILE up
		WHERE USER_ACCOUNT_ID ='TMTD1'
...
SELECT COUNT(*) 
	FROM ADMIN_PROFILE ap;
--47) 관리자 목록 조회
SELECT RN,ADPR_ID, ADPR_NAME ,ADPR_AUTH,ADPR_LAST_ACCESS 
	FROM(
...
SELECT USER_ACCOUNT_ID, USER_EMAIL,USER_NAME,USER_NICKNAME,
					USER_AUTH,USER_PHONE_NUMBER,USER_BIRTH,USER_JOIN_DATE,
					USER_LAST_ACCESS_DATE,USER_GENDER,USER_SITE,
					USER_DELFLAG,USJE_JEONGJI_SANGTAE,RN
			FROM(SELECT USER_ACCOUNT_ID, USER_EMAIL,USER_NAME,USER_NICKNAME,
					USER_AUTH,USER_PHONE_NUMBER,USER_BIRTH,USER_JOIN_DATE,
					USER_LAST_ACCESS_DATE,USER_GENDER,USER_SITE,
					USER_DELFLAG,USJE_JEONGJI_SANGTAE,ROW_NUMBER() OVER(ORDER BY USER_JOIN_DATE DESC) AS RN
				FROM(SELECT USER_ACCOUNT_ID, USER_EMAIL,USER_NAME,USER_NICKNAME,
						USER_AUTH,USER_PHONE_NUMBER,USER_BIRTH,USER_JOIN_DATE,
						USER_LAST_ACCESS_DATE,USER_GENDER,USER_SITE,
						USER_DELFLAG,USJE_JEONGJI_SANGTAE
					FROM(
...
SELECT USER_ACCOUNT_ID, USER_EMAIL,USER_NAME,USER_NICKNAME,
					USER_AUTH,USER_PHONE_NUMBER,TO_CHAR(USER_BIRTH,'YYYY-MM-DD'),USER_JOIN_DATE,
					USER_LAST_ACCESS_DATE,USER_GENDER,USER_SITE,
					USER_DELFLAG,USJE_JEONGJI_SANGTAE,RN
			FROM(SELECT USER_ACCOUNT_ID, USER_EMAIL,USER_NAME,USER_NICKNAME,
					USER_AUTH,USER_PHONE_NUMBER,USER_BIRTH,USER_JOIN_DATE,
