...
INSERT INTO ADMIN_ACCESS_IP_LIST
	(IP_ADDRESS, ADPR_ID)
	VALUES('0:0:0:0:0:0:0:1', 't_wjddns7828');
...
--48) 관리자 회원 상세 조회
SELECT USER_ACCOUNT_ID,USER_EMAIL ,USER_NAME ,USER_NICKNAME,USER_AUTH,USER_PHONE_NUMBER ,USER_JOIN_DATE ,USER_LAST_ACCESS_DATE ,USER_GENDER ,USER_SITE,USER_DELFLAG,SIUS_STATE,USJE_JEONGJI_SANGTAE
				FROM(
					SELECT USER_ACCOUNT_ID,USER_EMAIL ,USER_NAME ,USER_NICKNAME,USER_AUTH,USER_PHONE_NUMBER ,USER_JOIN_DATE ,USER_LAST_ACCESS_DATE ,USER_GENDER ,USER_SITE,USER_DELFLAG 
						FROM USER_PROFILE up 
					UNION
		...
		WHERE us.USER_ACCOUNT_ID ='TMTD121';
--49) 관리자 삭제 처리
	UPDATE ADMIN_PROFILE SET ADPR_DELFLAG ='Y'
		WHERE ADPR_ID ='wjddns7828';
