...
UPDATE CLASS_CHAMYEOJA SET CLCH_PILGI_STATUS = 'Y'
	WHERE CLCH_ACCOUNT_ID = 'TMTD1'
		AND CLCH_CLAS_ID = '1000000350';
	
SELECT *
	FROM PILGI_BOARD OUTER JOIN CLASS_CHAMYEOJA cc 
	ON PIBO_CLAS_ID = CLCH_CLAS_ID
	WHERE PIBO_WRITER_ID = 'TMTD1'
		AND CLCH_ACCOUNT_ID='TMTD1';
SELECT *
	FROM CLASS_CHAMYEOJA 
	WHERE CLCH_ACCOUNT_ID ='TMTD1'
		AND CLCH_STATUS='C'
	ORDER BY CLCH_CLAS_ID;
SELECT *
	FROM PILGI_BOARD
	WHERE PIBO_CLAS_ID='1000000350';
