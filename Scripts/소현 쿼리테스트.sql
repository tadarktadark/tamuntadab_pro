...
SELECT GAYE_ID, GAYE_GAGA_ID, GAYE_ACCOUNT_ID, GAYE_YEYAK_DATE , GAYE_START_TIME , GAYE_HOURS , GAYE_STATE , GAYE_CLAS_ID , GAYE_GYEOLJE_TYPE, GAYE_GYEOLJE_USER
	FROM (SELECT GAYE_ID, GAYE_GAGA_ID, (SELECT GACO_NAME
				...
				CLAS_TITLE AS GAYE_CLAS_ID , GAYE_GYEOLJE_TYPE, GAYE_GYEOLJE_USER,
				ROW_NUMBER() OVER(ORDER BY GAYE_YEYAK_DATE, GAYE_ID) AS rn
