...
SELECT PIBO_ID, PIBO_WRITER_ID , CLAS_TITLE, PIBO_CONTENT, c2.CLAS_SUBJECT_JEONGBO
...
SELECT ID, WRITER_ID , TITLE, REPLY_COUNT, CLAS_SUBJECT_JEONGBO AS SUBJECT_CODE, LIKE_USER, LIKE_COUNT, VIEW_COUNT, REGDATE ,PIBO_STATE
...
SELECT ID, TITLE, REPLY_COUNT, LIKE_COUNT, LIKE_USER, DELFLAG, REGDATE, "UPDATE",PIBO_STATE, SUBJECT_CODE
...
SELECT ID, TITLE, REPLY_COUNT, LIKE_COUNT, REGDATE, "UPDATE",PIBO_STATE, CLAS_SUBJECT_JEONGBO AS SUBJECT_CODE
