...
INSERT INTO PILGI_IMSIJEOJANG(PIIM_SEQ, PIIM_WRITER_ID, PIIM_CLAS_ID, 
						...
						VALUES(PILGI_IMSIJEOJANG_SEQ.NEXTVAL, 'TMTD2', '1000000082', 
							'필기 임시저장 테스트 데이터', 'A', 'A');
-- 필기 임시저장 목록 조회
SELECT PIIM_SEQ AS ID, SUBSTR(PIIM_CONTENT,1,10)||'...' AS CONTENT, PIIM_VIEW_GROUP AS VIEW_GROUP, PIIM_DOWNLOAD_GROUP AS DOWNLOAD_GROUP
	FROM PILGI_IMSIJEOJANG
	WHERE PIIM_WRITER_ID ='TMTD53'
		AND PIIM_CLAS_ID='1000000093';
