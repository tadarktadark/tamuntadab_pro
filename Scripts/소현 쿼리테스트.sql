...
SELECT PIBO_ID , USER_NICKNAME AS PIBO_WRITER_ID , CLAS_TITLE AS PIBO_CLAS_ID , PIBO_LIKE_USER , PIBO_VIEW_USER , PIBO_VIEW_GROUP , PIBO_DOWNLOAD_GROUP , PIBO_REGDATE
	FROM PILGI_BOARD JOIN USER_PROFILE up 
