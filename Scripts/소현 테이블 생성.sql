...
COMMENT ON COLUMN GANGEUISIL_YEYAK.GAYE_GYEO_ID IS '결제 ID';
...
CREATE SEQUENCE SINGO_SAYU_SEQ START WITH 135 INCREMENT BY 1 NOCACHE NOCYCLE;
...
CREATE SEQUENCE SINGO_USER_SEQ START WITH 8 INCREMENT BY 1 NOCACHE NOCYCLE;
...
CREATE SEQUENCE COMMUNITY_REPLY_SEQ START WITH 32 INCREMENT BY 1 NOCACHE NOCYCLE;
