...
CREATE TABLE CHAT_ROOM(
	...
	CHRO_CHAT_COUNT NUMBER DEFAULT 0
);
...
COMMENT ON COLUMN CHAT_ROOM.CHRO_CHAT_COUNT IS '채팅방 총 채팅수';

INSERT INTO CHAT_ROOM
(CHRO_ID, CHRO_CLAS_ID, CHRO_TITLE, CHRO_CHAT_LOG, CHRO_DATE,CHRO_CHAT_COUNT)
VALUES('CR230906' || TO_CHAR(CHRO_SEQ.NEXTVAL), 1000000048, 'Jenkins 구동 시연 해주세요', '', CURRENT_DATE,0);
INSERT INTO CHAT_ROOM
(CHRO_ID, CHRO_CLAS_ID, CHRO_TITLE, CHRO_CHAT_LOG, CHRO_DATE,CHRO_CHAT_COUNT)
VALUES('CR230906' || TO_CHAR(CHRO_SEQ.NEXTVAL), 1000000049, '자료 구조', '', CURRENT_DATE,0);
INSERT INTO CHAT_ROOM
(CHRO_ID, CHRO_CLAS_ID, CHRO_TITLE, CHRO_CHAT_LOG, CHRO_DATE,CHRO_CHAT_COUNT)
VALUES('CR230906' || TO_CHAR(CHRO_SEQ.NEXTVAL), 1000000050, '자료 구조', '', CURRENT_DATE,0);
INSERT INTO CHAT_ROOM
(CHRO_ID, CHRO_CLAS_ID, CHRO_TITLE, CHRO_CHAT_LOG, CHRO_DATE,CHRO_CHAT_COUNT)
VALUES('CR230906' || TO_CHAR(CHRO_SEQ.NEXTVAL), 1000000051, '구글 애널리틱스 써 보신 분 구합니다', '', CURRENT_DATE,0);
INSERT INTO CHAT_ROOM
(CHRO_ID, CHRO_CLAS_ID, CHRO_TITLE, CHRO_CHAT_LOG, CHRO_DATE,CHRO_CHAT_COUNT)
VALUES('CR230906' || TO_CHAR(CHRO_SEQ.NEXTVAL), 1000000052, 'Windows 시스템 프로그래밍 기본', '', CURRENT_DATE,0);
INSERT INTO CHAT_ROOM
(CHRO_ID, CHRO_CLAS_ID, CHRO_TITLE, CHRO_CHAT_LOG, CHRO_DATE,CHRO_CHAT_COUNT)
VALUES('CR230906' || TO_CHAR(CHRO_SEQ.NEXTVAL), 1000000053, 'IT 면접 과외', '', CURRENT_DATE,0);
...
COMMENT ON COLUMN CHAT_USER.CHUS_COUNT IS '읽은 채팅 수';
...
COMMENT ON COLUMN ALARM.ALAR_REPLY_SEQ IS '이동 링크';
COMMENT ON COLUMN ALARM.ALAR_CHECKED IS '확인 여부';

INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AT_C230906' || TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '클래스 알림 테스트', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AT_P230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '결제 알림 테스트', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AT_R230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '게시글 답글 알림 테스트', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AT_I230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '경력 인증 알림 테스트', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AT_S230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '강의료 정산 알림 테스트', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AL230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '알림 테스트 6', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AL230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '알림 테스트 7', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AL230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '알림 테스트 8', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AL230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '알림 테스트 9', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AL230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '알림 테스트 10', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AL230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '알림 테스트 11', SYSDATE, 'main.do', 'N');
INSERT INTO ALARM(ALAR_ID, ALAR_ACCOUNT_ID, ALAR_CONTENT, ALAR_EVENTDATE, ALAR_REPLY_SEQ, ALAR_CHECKED) VALUES('AL230906'|| TO_CHAR(ALARM_SEQ.NEXTVAL), 'TMTD16', '알림 테스트 12', SYSDATE, 'main.do', 'N');
