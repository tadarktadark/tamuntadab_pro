...
public class AdminAuthBInterceptor implements AsyncHandlerInterceptor{
	@Override
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
			throws Exception {
		AdminVo adminInfo = (AdminVo) request.getSession().getAttribute("adminInfo");
		if(adminInfo != null) {
			if((!adminInfo.getAdprAuth().equals("B")) && (!adminInfo.getAdprAuth().equals("M")) && (!adminInfo.getAdprAuth().equals("T"))) {
