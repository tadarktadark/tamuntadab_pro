...
<link href="./css/myBoard.css" rel="stylesheet" type="text/css" />
	...
	<div class="card-body">
		...
		<ul class="nav nav-pills nav-customs nav-danger"
			role="tablist">
			<li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#border-navs" role="tab">클래스 결제 목록</a>
			</li>
			<li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#border-navs" role="tab">강의실 결제 목록</a></li>
		</ul>
		<div class="card mb-0">
			<!-- Tab panes -->
