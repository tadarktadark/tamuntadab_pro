		...
		<div class="main-content">
			<div class="page-content">
				...
				<div style="width: 50%; margin: auto;">
					...
					<div style="position: fixed; left: 1270px; bottom: 740px;">
					<button type="button" class="btn btn-outline-success btn-icon" style="font-size:1.7em;"><a href="#">
					<i class="ri-customer-service-2-line"></i></a></button><br>
						문의하기
					</div>
