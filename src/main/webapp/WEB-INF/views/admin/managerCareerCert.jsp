					...
					<div class="accordion-item mt-2">
						<h2 class="accordion-header"
							...
							<input type="hidden" id="userAccountId"
								value="${career.careAccountId}"> <input type="hidden"
								id="careId" value="${career.careId}">
						</h2>
									...
									<table class="table table-striped"
										...
										<tbody>
											<tr style="text-align: center; vertical-align: middle;">
												...
												<c:choose>
													...
													<c:when test="${career.careStatus eq 'S'}">
														<td>&nbsp;</td>
														<td>&nbsp;</td>
														<td><button type="button" class="btn btn-danger w-xs"
																onclick="updateD('${career.careId}')">목록삭제</button></td>
														<td>&nbsp;</td>
														<td>&nbsp;</td>
													</c:when>
													<c:when test="${career.careStatus eq 'R'}">
														...
														<td>&nbsp;</td>
														<td><button type="button" class="btn btn-danger w-xs"
																onclick="deleteDB('${career.careId}')">DB삭제</button></td>
														<td>&nbsp;</td>
														<td>&nbsp;</td>
													</c:when>
												</c:choose>
											...
											<tr class="editInput"
												...
												<td><button type="button" class="btn btn-success w-xs"
														onclick="submitEdit('${career.careId}')">
														<i class="bx bx-check"
			...
			<ul class="pagination pagination-rounded justify-content-center mt-4">
				...
				<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
					<c:choose>
						...
						<c:otherwise>
							<li class="page-item"><a href="./managerCareer.do?page=${i}"
				...
				<c:choose>
					<c:when test="${page.page<page.totalPage}">
						<li class="page-item"><a
							href="./managerCareer.do?page=${page.page + 1}" class="page-link">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="varyingcontentModalLabel">반려 사유 등록</h5>
			...
			<form>
				<div class="modal-body">
					...
					<div class="mb-3">
						...
						<textarea class="form-control" id="careReason" name="careReason"></textarea>
